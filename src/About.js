...
We will be using HTML, CSS, and Java as our scripting language.  Our website will be hosted on Git Hub pages and executing via React.  We will be using MongoDB to house our five data tables. 
